...
OVERRIDES = {
    ...
    "Blocked RCE DoS": (False, "destructive DoS — system must not run DoS against target"),
    "Successful RCE DoS": (False, "destructive DoS — system must not run DoS against target"),
...
WSTG_OVERRIDE = {
    ...
    "Missing Encoding": "WSTG-INPV-01",
    "GDPR Data Theft": "WSTG-ATHZ-04",
